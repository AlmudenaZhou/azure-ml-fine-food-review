...
def main():
    ...
    parser.add_argument("--model_filename", type=str, required=False, help="name of the filename that contains the model")
    ...
    model_path = args.model_path + f"/{args.model_filename}"
    _ = ModelTrainingStep(model_path=model_path).main(X_train, y_train)
